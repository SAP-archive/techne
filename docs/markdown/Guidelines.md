...
<div class="hyGuidelinesPage container-fluid" >
    ...
    <section id="visual-system" class="page">
        ...
        <div class="row visualSystemSpacing typographyAlignment circleTextSize">
            <div class="row text-center">
                <div class="col-md-5ths col-xs-4">
                    <div class="circle screen-bg">
                    </div>
                    <p class="no-bottom-margin">Screen Background</p>
                    <h4>#E0E9F0</h4>
                </div>
                <div class="col-md-5ths col-xs-4">
                    <div class="circle content-bg">
                    </div>
                    <p class="no-bottom-margin">Content Background</p>
                    <h4>#FFFFFF</h4>
                </div>
                <div class="col-md-5ths col-xs-4">
                    <div class="circle typography">
                    </div>
                    <p class="no-bottom-margin">Typography (Main)</p>
                    <h4>#313440</h4>
                </div>
                <div class="col-md-5ths col-xs-4">
                    <div class="circle typographySecondValue">
                    </div>
        ...
        <div class="row visualSystemSpacing typographyAlignment">
            ...
            <div class="imageCenter">
                <a href="https://www.google.com/fonts/specimen/Dosis">
